...
function(a){_gas.i=a}]);_gas.push(["_addHook","_trackPageview",function(a,b){if(b&&typeof b==="string"){var c=g.title;h.s.push(function(){g.title=b},["_trackPageview",a],function(){g.title=c});return!1}return[a]}]);_gas.push(["_addHook","_trackDownloads",function(a){a?typeof a==="string"?a={extensions:a.split(",")}:a.length>=1&&(a={extensions:a}):a={extensions:[]};a.category=a.category||"Download";var b="xls,xlsx,doc,docx,ppt,pptx,pdf,txt,zip";b+=",rar,7z,exe,wma,mov,avi,wmv,mp3,csv,tsv";b=b.split(",");
a.extensions=a.extensions.concat(b);P.call(this,a);return!1}]);_gas.push(["_addHook","_trackEvent",function(){var a=m.call(arguments);a[3]&&(a[3]=(a[3]<0?0:Math.round(a[3]))||0);return a}]);_gas.push(["_addHook","_trackForms",function(a){var b=this;typeof a==="boolean"?a={live:a}:typeof a!=="object"&&(a={});a.category=a.category||"Form Tracking";a.live=a.live||!0;this.h(function(){for(var c=g.getElementsByTagName("form"),d=0;d<c.length;d++){try{Q.call(b,c[d],a)}catch(f){}if(a.live)break}return!1})}]);
_gas.push(["_addHook","_trackVideo",function(){G.call(this,"video")}]);_gas.push(["_addHook","_trackAudio",function(){G.call(this,"audio")}]);var A=null,k=0,u;_gas.push(["_addHook","_trackMaxScroll",function(a){u=a||{};u.category=u.category||"Max Scroll";this.a(h,"scroll",I);this.a(h,"beforeunload",R)}]);_gas.e=!1;_gas.push(["_addHook","_setAllowAnchor",function(a){_gas.e=!!a}]);_gas.push(["_addHook","_link",function(a,b){if(b===n)b=_gas.e;return[a,b]}]);_gas.push(["_addHook","_linkByPost",function(a,
b){if(b===n)b=_gas.e;return[a,b]}]);var y=[],N=n;_gas.push(["_addHook","_setDomainName",function(a){if(j.call("."+g.location.hostname,a)<0)return y.push(a),!1;N=a}]);_gas.push(["_addHook","_addExternalDomainName",function(a){y.push(a);return!1}]);_gas.push(["_addHook","_setMultiDomain",function(a){var b=g.location.hostname,c=this,d,f,e,h=g.getElementsByTagName("a");a!=="now"&&a!=="mousedown"&&(a="click");for(d=0;d<h.length;d++)if(e=h[d],j.call(e.href,"http")===0&&!(e.hostname==b||j.call(e.hostname,
N)>=0))for(f=0;f<y.length;f++)if(j.call(e.hostname,y[f])>=0)a==="now"?e.href=c.tracker._getLinkerUrl(e.href,_gas.e):a==="click"?this.a(e,a,function(a){_gas.push(["_link",this.href,_gas.e]);a.preventDefault?a.preventDefault():a.returnValue=!1}):this.a(e,a,function(){this.href=c.tracker._getLinkerUrl(this.href,_gas.e)});return!1}]);_gas.push(["_addHook","_trackOutboundLinks",function(a){a||(a={});a.categpry=a.categpry||"Outbound";for(var b=g.getElementsByTagName("a"),c=0;c<b.length;c++)this.a(b[c],
"mousedown",function(b){b=b.target;if((b.protocol=="http:"||b.protocol=="https:")&&j.call(b.href,g.location.hostname)===-1){var c=b.pathname+b.search+"",e=j.call(c,"__utm");e!==-1&&(c=c.substring(0,e));_gas.push(["_trackEvent",a.category,b.hostname,c])}})}]);var L=[],p={},B={},M=!1,v;_gas.push(["_addHook","_trackVimeo",function(a){var b=this;if(typeof a==="boolean"||a==="force")a={force:!!a};a=a||{};a.category=a.category||"Vimeo Video";a.percentages=a.percentages||[];a.force=a.force||!1;v=a;b.h(function(){K.call(b)});
return!1}]);var x=[],w,l={};for(_gas.push(["_addHook","_trackYoutube",function(a){var b=m.call(arguments),a=b[0]&&(typeof b[0]==="boolean"||b[0]==="force")?{force:!!b[0]}:{};b[1]&&b[1].length&&(a.percentages=b[1]);a=a||{};a.force=a.force||!1;a.category=a.category||"YouTube Video";a.percentages=a.percentages||[];w=a;var c=this;c.h(function(){W.call(c,a)});return!1}]);_gas.m.length>0;)_gas.push(_gas.m.shift());_gaq&&_gaq.length>=0&&function(){var a=g.createElement("script");a.type="text/javascript";
a.async=!0;a.src=("https:"==g.location.protocol?"https://ssl":"http://www")+".google-analytics.com/ga.js";var b=g.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}()}})(window);
