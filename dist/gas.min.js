...
b.type.toLowerCase())&&c(a)}catch(e){}}),d.a(g.body,"change",function(a){try{var b=a.target;a.type=="change"&&d.j(["input","select","textarea","hidden"],b.nodeName.toLowerCase())&&c(a)}catch(e){}});else{var f,e;if(!a.elements||!a.elements.length)return!1;for(f=0;f<a.elements.length;f++)e=a.elements[f],d.j(["button","submit","image","reset"],e.type)?d.a(e,"click",c):d.a(e,"change",c);d.a(a,"submit",c)}}function z(a){_gas.push(["_trackEvent",this.tagName,a.type,this.currentSrc])}function G(a){var b=
this;b.h(function(){for(var c=g.getElementsByTagName(a),d=0;d<c.length;d++)b.a(c[d],"play",z),b.a(c[d],"ended",z),b.a(c[d],"pause",z)})}function H(){return Math.max(g.body.scrollHeight||0,o.scrollHeight||0,g.body.offsetHeight||0,o.offsetHeight||0,g.body.clientHeight||0,o.clientHeight||0)}function I(a){A&&clearTimeout(A);a===!0?k=Math.max(((h.pageYOffset||g.body.scrollTop||o.scrollTop||0)+(h.innerHeight||o.clientHeight||g.body.clientHeight||0))/H()*100,k):A=setTimeout(function(){k=Math.max(((h.pageYOffset||
g.body.scrollTop||o.scrollTop||0)+(h.innerHeight||o.clientHeight||g.body.clientHeight||0))/H()*100,k)},400)}function R(){I(!0);k=Math.floor(k);if(!(k<=0||k>100)){var a=(k>10?1:0)*(Math.floor((k-1)/10)*10+1),a=String(a)+"-"+String(Math.ceil(k/10)*10);_gas.push(["_trackEvent",u.category,J,a,Math.floor(k),!0])}}function s(a,b,c){if(c.contentWindow&&c.contentWindow.postMessage&&JSON){var d=c.getAttribute("src").split("?")[0],a=JSON.stringify({method:a,value:b});c.contentWindow.postMessage(a,d)}}function S(a){if(j.call(a.origin,
"//player.vimeo.com")>-1)if(a=JSON.parse(a.data),a.event==="ready")K.call(_gas.g);else if(a.method){if(a.method=="getVideoUrl")B[a.b]=a.value}else if(a.event==="playProgress"){if(!q[a.b])q[a.b]={},q[a.b].d=m.call(L);if(q[a.b].d.length>0&&a.data.t*100>=q[a.b].d[0]){var b=q[a.b].d.shift();_gas.push(["_trackEvent","Vimeo Video",b+"%",B[a.b]])}}else _gas.push(["_trackEvent",v.category,a.event,B[a.b]])}function K(){for(var a=g.getElementsByTagName("iframe"),b=0,c,d,f,e=v.force,F=v.percentages,i=0;i<a.length;i++)if(j.call(a[i].src,
...
a.parentNode.insertBefore(b,a)}p.prototype.n=function(){if(!this.tracker){var a=h._gat._getTrackers();a.length>0&&(this.tracker=a[0])}};p.prototype.j=function(a,b){if(a&&a.length)for(var c=0;c<a.length;c++)if(a[c]===b)return!0;return!1};p.prototype.isArray=function(a){return X.call(a)==="[object Array]"};p.prototype.a=function(a,b,c,d){function f(b){if(!b||!b.target)b=h.event,b.target=b.srcElement;return c.call(a,b)}a.addEventListener?a.addEventListener(b,f,!!d):a.attachEvent?a.attachEvent("on"+b,
f):(b="on"+b,typeof a[b]==="function"&&(f=function(a,b){return function(){a.apply(this,arguments);b.apply(this,arguments)}}(a[b],f)),a[b]=f)};p.prototype.h=function(a){function b(){if(!arguments.callee.r)arguments.callee.r=!0,a.apply(c,arguments)}var c=this;/^(interactive|complete)/.test(g.readyState)?b():(this.a(g,"DOMContentLoaded",b,!1),this.a(h,"load",b,!1))};h._gaq=h._gaq||[];var E=h._gas||[];if(!(E.k>=0)){var g=h.document,X=Object.prototype.toString,Y=Object.prototype.hasOwnProperty,m=Array.prototype.slice,
j=String.prototype.indexOf,J=g.location.href,o=g.documentElement;t.prototype.o=function(a,b){typeof a==="string"&&typeof b==="function"&&(typeof _gas.f[a]==="undefined"&&(_gas.f[a]=[]),_gas.f[a].push(b));return!1};t.prototype.p=function(){var a=m.call(arguments),b=a.shift(),a=!0,c,d,f,e,g,i=0;if(typeof b==="function")return r(function(a,b){return function(){a.call(b)}}(b,this.g));else if(typeof b==="object"&&b.length>0){d=b.shift();j.call(d,".")>=0?(e=d.split(".")[0],d=d.split(".")[1]):e=n;if((f=
this.f[d])&&f.length>0)for(c=0;c<f.length;c++)try{g=f[c].apply(this.g,b),g===!1?a=!1:g&&g.length>0&&(b=g)}catch(h){d!=="_trackException"&&this.push(["_trackException",h])}if(a===!1)return 1;if(d==="_setAccount"){for(c in this.c)if(this.c[c]==b[0]&&e===n)return 1;e=e||"_gas"+String(this.k+1);typeof this.c._gas1=="undefined"&&j.call(e,"_gas")!=-1&&(e="_gas1");this.c[e]=b[0];this.k+=1;e=e===_gas.i?"":e+".";i=r([e+d,b[0]]);this.g.n();return i}if(d==="_link"||d==="_linkByPost")return a=m.call(b),a.unshift(d),
r(a);if(e&&this.c[e])return g=(e===_gas.i?"":e+".")+d,a=m.call(b),a.unshift(g),r(a);for(c in this.c)Y.call(this.c,c)&&(g=(c===_gas.i?"":c+".")+d,a=m.call(b),a.unshift(g),i+=r(a));return i?1:0}};t.prototype.push=function(){for(var a=m.call(arguments),b=0;b<a.length;b++)(function(a,b){h._gaq.push(function(){b.p.call(b,a)})})(a[b],this)};h._gas=_gas=new t;_gas.push(["_addHook","_trackException",function(a,b){_gas.push(["_trackEvent","Exception "+(a.name||"Error"),b||a.message||a,J]);return!1}]);_gas.push(["_addHook",
