...
*/
(function(h,n){function p(){this.m()}function r(){var a=this;a.version="1.0.0";a.b={};a.i=0;a.l=z;a.f="_gas1";a.g={};a.d={_addHook:[a.n]};a.push(function(){a.g=new p})}function q(a){if(_gas.p)try{console.log(a)}catch(b){}return h._gaq.push(a)}function I(a,b){if(typeof a!=="string")return!1;var c=a.split("?")[0],c=c.split(".");return(c=c[c.length-1])&&this.h(b,c)?c:!1}function J(a){for(var b=this,c=g.getElementsByTagName("a"),d=0;d<c.length;d++)this.a(c[d],"mousedown",function(c){if(c.target&&c.target.tagName===
"A"){var d=I.call(b,c.target.href,a);d&&_gas.push(["_trackEvent","Download",d,c.target.href])}})}function K(a,b){function c(b){var c=b.target,c=c.name||c.id||c.type||c.nodeName,b=b.type,d=a.name||a.id||n;_gas.push(["_trackEvent","Form Tracking","form"+(d?" ("+d+")":""),c+" ("+b+")"])}var d=this;if(b)d.a(h,"click",function(a){try{var b=a.target;a.type=="click"&&d.h(["button","submit","image","reset"],b.type.toLowerCase())&&c(a)}catch(f){}}),d.a(g.body,"change",function(a){try{var b=a.target;a.type==
"change"&&d.h(["input","select","textarea","hidden"],b.nodeName.toLowerCase())&&c(a)}catch(f){}});else{var e,f;if(!a.elements||!a.elements.length)return!1;for(e=0;e<a.elements.length;e++)f=a.elements[e],d.h(["button","submit","image","reset"],f.type)?d.a(f,"click",c):d.a(f,"change",c);d.a(a,"submit",c)}}function v(a){_gas.push(["_trackEvent",this.tagName,a.type,this.currentSrc])}function A(a){var b=this;b.e(function(){for(var c=g.getElementsByTagName(a),d=0;d<c.length;d++)b.a(c[d],"play",v),b.a(c[d],
"ended",v),b.a(c[d],"pause",v)})}function B(){return Math.max(g.body.scrollHeight||0,o.scrollHeight||0,g.body.offsetHeight||0,o.offsetHeight||0,g.body.clientHeight||0,o.clientHeight||0)}function C(a){w&&clearTimeout(w);a===!0?j=Math.max(((h.pageYOffset||g.body.scrollTop||o.scrollTop||0)+(h.innerHeight||o.clientHeight||g.body.clientHeight||0))/B()*100,j):w=setTimeout(function(){j=Math.max(((h.pageYOffset||g.body.scrollTop||o.scrollTop||0)+(h.innerHeight||o.clientHeight||g.body.clientHeight||0))/B()*
100,j)},400)}function L(){C(!0);j=Math.floor(j);if(!(j<=0||j>100)){var a=(j>10?1:0)*(Math.floor((j-1)/10)*10+1),a=String(a)+"-"+String(Math.ceil(j/10)*10);_gas.push(["_trackEvent","Max Scroll",D,a,Math.floor(j),!0])}}function s(a,b,c){if(c.contentWindow&&c.contentWindow.postMessage){var d=c.getAttribute("src").split("?")[0],a=JSON.stringify({method:a,value:b});c.contentWindow.postMessage(a,d)}}function E(a){for(var b=g.getElementsByTagName("iframe"),c=0,d,e,f,k=0;k<b.length;k++)if(i.call(b[k].src,
"//player.vimeo.com")>-1){d="gas_vimeo_"+k;e=b[k].src;f="?";i.call(e,"?")>-1&&(f="&");if(i.call(e,"api=1")<0)if(a)e+=f+"api=1&player_id="+d;else break;else i.call(e,"player_id=")<-1&&(e+=f+"player_id="+d);c++;b[k].id=d;if(b[k].src!==e){b[k].src=e;break}s("getVideoUrl","",b[k]);s("addEventListener","play",b[k]);s("addEventListener","pause",b[k]);s("addEventListener","finish",b[k])}c>0&&F===!1&&(this.a(h,"message",function(a){if(i.call(a.origin,"//player.vimeo.com")>-1)if(a=JSON.parse(a.data),a.event===
"ready")E();else if(a.method){if(a.method=="getVideoUrl")G[a.r]=a.value}else _gas.push(["_trackEvent","Vimeo Video",a.event,G[a.r]])},!1),F=!0)}function x(a,b){if(l[b]==n||l[b].j.length<=0)return!1;if(a.getCurrentTime()/a.getDuration()*100>=l[b].j[0]){var c=l[b].j.shift();_gas.push(["_trackEvent","YouTube Video",c+"%",a.getVideoUrl()])}l[b].k=setTimeout(x,1E3,a,b)}function y(a){var b=a.getVideoData().video_id;l[b]&&l[b].k&&(x(a,b),clearTimeout(l[b].k))}function M(a){var b="";switch(a.data){case 0:b=
...
(f="https:"),e.src=f+"//www.youtube.com/player_api",e.type="text/javascript",e.async=!0,f=g.getElementsByTagName("script")[0],f.parentNode.insertBefore(e,f)}p.prototype.m=function(){if(!this.tracker){var a=h._gat._getTrackers();a.length>0&&(this.tracker=a[0])}};p.prototype.h=function(a,b){if(a&&a.length)for(var c=0;c<a.length;c++)if(a[c]===b)return!0;return!1};p.prototype.isArray=function(a){return Q.call(a)==="[object Array]"};p.prototype.a=function(a,b,c,d){function e(b){if(!b||!b.target)b=h.event,
b.target=b.srcElement;return c.call(a,b)}a.addEventListener?a.addEventListener(b,e,!!d):a.attachEvent?a.attachEvent("on"+b,e):(b="on"+b,typeof a[b]==="function"&&(e=function(a,b){return function(){a.apply(this,arguments);b.apply(this,arguments)}}(a[b],e)),a[b]=e)};p.prototype.e=function(a){function b(){if(!arguments.callee.q)arguments.callee.q=!0,a.apply(c,arguments)}var c=this;/^(interactive|complete)/.test(g.readyState)?b():(this.a(g,"DOMContentLoaded",b,!1),this.a(h,"load",b,!1))};h._gaq=h._gaq||
[];var z=h._gas||[];if(!(z.i>=0)){var g=h.document,Q=Object.prototype.toString,R=Object.prototype.hasOwnProperty,m=Array.prototype.slice,i=String.prototype.indexOf,D=g.location.href,o=g.documentElement;r.prototype.n=function(a,b){typeof a==="string"&&typeof b==="function"&&(typeof _gas.d[a]==="undefined"&&(_gas.d[a]=[]),_gas.d[a].push(b));return!1};r.prototype.o=function(){var a=m.call(arguments),b=a.shift(),a=!0,c,d,e,f,g,h=0;if(typeof b==="function")return q(function(a,b){return function(){a.call(b)}}(b,
this.g));else if(typeof b==="object"&&b.length>0){d=b.shift();i.call(d,".")>=0?(f=d.split(".")[0],d=d.split(".")[1]):f=n;if((e=this.d[d])&&e.length>0)for(c=0;c<e.length;c++)try{g=e[c].apply(this.g,b),g===!1?a=!1:g&&g.length>0&&(b=g)}catch(j){d!=="_trackException"&&this.push(["_trackException",j])}if(a===!1)return 1;if(d==="_setAccount"){for(c in this.b)if(this.b[c]==b[0]&&f===n)return 1;f=f||"_gas"+String(this.i+1);typeof this.b._gas1=="undefined"&&i.call(f,"_gas")!=-1&&(f="_gas1");this.b[f]=b[0];
this.i+=1;f=f===_gas.f?"":f+".";h=q([f+d,b[0]]);this.g.m();return h}if(d==="_link"||d==="_linkByPost")return a=m.call(b),a.unshift(d),q(a);if(f&&this.b[f])return g=(f===_gas.f?"":f+".")+d,a=m.call(b),a.unshift(g),q(a);for(c in this.b)R.call(this.b,c)&&(g=(c===_gas.f?"":c+".")+d,a=m.call(b),a.unshift(g),h+=q(a));return h?1:0}};r.prototype.push=function(){for(var a=m.call(arguments),b=0;b<a.length;b++)(function(a,b){h._gaq.push(function(){b.o.call(b,a)})})(a[b],this)};h._gas=_gas=new r;_gas.push(["_addHook",
"_trackException",function(a,b){_gas.push(["_trackEvent","Exception "+(a.name||"Error"),b||a.message||a,D]);return!1}]);_gas.push(["_addHook","_setDebug",function(a){_gas.p=!!a}]);_gas.push(["_addHook","_popHook",function(a){(a=_gas.d[a])&&a.pop&&a.pop();return!1}]);_gas.push(["_addHook","_setDefaultTracker",function(a){_gas.f=a}]);_gas.push(["_addHook","_trackPageview",function(a,b){if(b&&typeof b==="string"){var c=g.title;h.s.push(function(){g.title=b},["_trackPageview",a],function(){g.title=c});
return!1}return[a]}]);_gas.push(["_addHook","_trackDownloads",function(a){var b="xls,xlsx,doc,docx,ppt,pptx,pdf,txt,zip";b+=",rar,7z,exe,wma,mov,avi,wmv,mp3,csv,tsv";b=b.split(",");typeof a==="string"?b=b.concat(a.split(",")):this.isArray(a)&&(b=b.concat(a));J.call(this,b);return!1}]);_gas.push(["_addHook","_trackEvent",function(){var a=m.call(arguments);a[3]&&(a[3]=(a[3]<0?0:Math.round(a[3]))||0);return a}]);_gas.push(["_addHook","_trackForms",function(a){var b=this;this.e(function(){for(var c=g.getElementsByTagName("form"),
d=0;d<c.length;d++){try{K.call(b,c[d],a)}catch(e){}if(a)break}return!1})}]);_gas.push(["_addHook","_trackVideo",function(){A.call(this,"video")}]);_gas.push(["_addHook","_trackAudio",function(){A.call(this,"audio")}]);var w=null,j=0;_gas.push(["_addHook","_trackMaxScroll",function(){this.a(h,"scroll",C);this.a(h,"beforeunload",L)}]);_gas.c=!1;_gas.push(["_addHook","_setAllowAnchor",function(a){_gas.c=!!a}]);_gas.push(["_addHook","_link",function(a,b){if(b===n)b=_gas.c;return[a,b]}]);_gas.push(["_addHook",
"_linkByPost",function(a,b){if(b===n)b=_gas.c;return[a,b]}]);var u=[],H=n;_gas.push(["_addHook","_setDomainName",function(a){if(i.call("."+g.location.hostname,a)<0)return u.push(a),!1;H=a}]);_gas.push(["_addHook","_addExternalDomainName",function(a){u.push(a);return!1}]);_gas.push(["_addHook","_setMultiDomain",function(a){var b=g.location.hostname,c=this,d,e,f,h=g.getElementsByTagName("a");a!=="now"&&a!=="mousedown"&&(a="click");for(d=0;d<h.length;d++)if(f=h[d],i.call(f.href,"http")===0&&!(f.hostname==
b||i.call(f.hostname,H)>=0))for(e=0;e<u.length;e++)if(i.call(f.hostname,u[e])>=0)a==="now"?f.href=c.tracker._getLinkerUrl(f.href,_gas.c):a==="click"?this.a(f,a,function(a){_gas.push(["_link",this.href,_gas.c]);a.preventDefault?a.preventDefault():a.returnValue=!1}):this.a(f,a,function(){this.href=c.tracker._getLinkerUrl(this.href,_gas.c)});return!1}]);_gas.push(["_addHook","_trackOutboundLinks",function(){for(var a=g.getElementsByTagName("a"),b=0;b<a.length;b++)this.a(a[b],"mousedown",function(a){a=
a.target;if((a.protocol=="http:"||a.protocol=="https:")&&i.call(a.href,g.location.hostname)===-1){var b=a.pathname+a.search+"",e=i.call(b,"__utm");e!==-1&&(b=b.substring(0,e));_gas.push(["_trackEvent","Outbound",a.hostname,b])}})}]);var G={},F=!1;_gas.push(["_addHook","_trackVimeo",function(a){var b=this;b.e(function(){E.call(b,a)});return!1}]);var t=[],l={};for(_gas.push(["_addHook","_trackYoutube",function(){var a=m.call(arguments),b=this;b.e(function(){P.apply(b,a)});return!1}]);_gas.l.length>
0;)_gas.push(_gas.l.shift());_gaq&&_gaq.length>=0&&function(){var a=g.createElement("script");a.type="text/javascript";a.async=!0;a.src=("https:"==g.location.protocol?"https://ssl":"http://www")+".google-analytics.com/ga.js";var b=g.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}()}})(window);
