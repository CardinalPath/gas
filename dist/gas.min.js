...
*/
(function(h,n){function q(){this.n()}function t(){var a=this;a.version="1.2.0";a.c={};a.k=0;a.m=E;a.i="_gas1";a.g={};a.f={_addHook:[a.o]};a.push(function(){a.g=new q})}function r(a){if(_gas.q)try{console.log(a)}catch(b){}return h._gaq.push(a)}function O(a,b){if(typeof a!=="string")return!1;var c=a.split("?")[0],c=c.split(".");return(c=c[c.length-1])&&this.j(b,c)?c:!1}function P(a){for(var b=this,c=g.getElementsByTagName("a"),d=0;d<c.length;d++)this.a(c[d],"mousedown",function(c){if(c.target&&c.target.tagName===
