...
*/
(function(h,m){function o(){this.tracker=h._gat._getTrackers()[0]}function q(){var a=this;a.b={};a.h=0;a.j=u;a.e="_gas1";a.i={};a.d={_addHook:[a.k]};a.push(function(){a.i=new o})}function p(a){if(_gas.m)try{console.log(a)}catch(b){}return h._gaq.push(a)}function C(a,b){if(typeof a!=="string")return!1;var c=a.split("?")[0],c=c.split(".");return(c=c[c.length-1])&&this.f(b,c)?c:!1}function D(a){var b=this;this.a(h,"mousedown",function(c){if(c.target&&c.target.tagName==="A"){var d=C.call(b,c.target.href,
a);d&&_gas.push(["_trackEvent","Download",d,c.target.href])}})}function E(a,b){function c(b){var c=b.target,c=c.name||c.id||c.type||c.nodeName,b=b.type,d=a.name||a.id||m;_gas.push(["_trackEvent","Form Tracking","form"+(d?" ("+d+")":""),c+" ("+b+")"])}var d=this;if(b)d.a(h,"click",function(a){try{var b=a.target;a.type=="click"&&d.f(["button","submit","image","reset"],b.type.toLowerCase())&&c(a)}catch(e){}}),d.a(f.body,"change",function(a){try{var b=a.target;a.type=="change"&&d.f(["input","select",
"textarea","hidden"],b.nodeName.toLowerCase())&&c(a)}catch(e){}});else{var g,e;if(!a.elements||!a.elements.length)return!1;for(g=0;g<a.elements.length;g++)e=a.elements[g],d.f(["button","submit","image","reset"],e.type)?d.a(e,"click",c):d.a(e,"change",c);d.a(a,"submit",c)}}function v(){return Math.max(f.body.scrollHeight||0,l.scrollHeight||0,f.body.offsetHeight||0,l.offsetHeight||0,f.body.clientHeight||0,l.clientHeight||0)}function w(a){t&&clearTimeout(t);a===!0?k=Math.max(((h.pageYOffset||f.body.scrollTop||
